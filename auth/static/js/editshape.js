...
if (delcheck==0) {
  ...
  document.getElementById("fill").value = mySel.fill;
...
function toggle(tx,ty,tname) {
  ...
  //var cal = document.getElementById("black_bk"); 
...
function statuscall(){
    document.getElementById("status").value = document.querySelector('input[name="status"]:checked').value;
}
