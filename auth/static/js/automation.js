...
function auto(){
        ...
        co.fillStyle = 'green';
        co.beginPath();
        co.arc(50, 55, 50, 0, 2 * Math.PI, false);
        co.fill();
        ...
        */
        var div1 = document.createElement('au');
        ...
        var div3 = document.getElementById('automation')
        div3.style.position = 'absolute';
            div3.style.top   = canvasXY[1] + 50 + 'px';
            div3.style.left  = canvasXY[0] + 50 + 'px';
        /**
        * Now create and position the circle DIV tag
        */
        var div2 = document.createElement('DIV');
            div2.style.position = 'absolute';
            div2.style.top   = canvasXY[1] + 50  - 50 + 'px';
            div2.style.left  = canvasXY[0] + 50 - 50 + 'px';
...
function toggle(tx,ty,tname) {
  ...
  el.style.left=tx-125+'px';
  el.style.top=ty-120+'px';
