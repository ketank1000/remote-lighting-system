...
function init() {
  ...
  s.addShape(new Shape(60,140,30,30, 'lightskyblue'));
  // Lets make some partially transparent
  s.addShape(new Shape(80,150,30,30, 'rgba(127, 255, 212, .5)'));
  s.addShape(new Shape(125,80,30,30, 'rgba(245, 222, 179, .7)'));
}
